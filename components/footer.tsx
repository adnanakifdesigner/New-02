              ...
              >
                <div className="py-1 md:py-2 px-2 lg:px-3 md:pr-3">
                  <motion.span
                    ...
                    animate={{
                      backgroundColor: hoveredCTA === 'contact' ? '#26775C' : '#F2EDE4',
                      color: hoveredCTA === 'contact' ? '#F2EDE4' : '#26775C',
              ...
              >
                <div className="py-1 md:py-2 px-2 lg:px-3 md:pr-3">
                  <motion.span
                    className="block w-full px-4 md:px-6 py-2 md:py-3 font-semibold text-[16px] md:text-[18px] tracking-tighter uppercase text-center"
                    animate={{
                      backgroundColor: hoveredCTA === 'book' ? '#26775C' : '#F2EDE4',
                      color: hoveredCTA === 'book' ? '#F2EDE4' : '#26775C',
            ...
            <motion.div>
              ...
              >
                <div className="relative h-6 md:h-7">
                  <motion.span
                    className="block text-[#F2EDE4] font-semibold text-[16px] md:text-[18px] tracking-tight uppercase absolute right-0"
                    animate={{
                  ...
                  <motion.span
                    className="block text-[#F2EDE4] font-semibold text-[14px] md:text-[16px] tracking-tight absolute right-0"
                    animate={{
